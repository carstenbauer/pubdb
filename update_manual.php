...
<body onload='printPublication();'>
    ...
    <p>
        Please use the manual update <b>only for unsupported journals</b>. If you think that your publication is no
    ...
    <div id="insertformdiv">
        ...
        <?php if (!isset($_POST['confirm'])) { ?>
            ...
            <form action="index.php?sec=update_manual&id=<?php echo $oldpaper["id"]; ?>" method="post">
                ...
                <br><br>
                <input type="submit" name="insertForm" value="Submit"> &nbsp; <input type="button" name="abort"
                    value="Abort" onClick="window.location='index.php?sec=show';" /><span class="small"
                    style='margin-left: 10px;'>(You will be able to verify your publication entry before final
                    update.)</span>
            </form>
    ...
    if (isset($_POST["insertForm"])) {
        ...
        if ($validInput !== true) {
            ...
            <form action="index.php?sec=update_manual&id=<?php echo $oldpaper["id"]; ?>" method="post">
                ...
                <?php echo join(', ', $_POST["projects"]); ?>.<br><br>
